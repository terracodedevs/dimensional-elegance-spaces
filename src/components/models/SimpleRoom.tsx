  ...
  return (
    <group ref={groupRef} {...props}>
      ...
      <mesh position={[0, -0.05, 0]} rotation={[-Math.PI / 2, 0, 0]} receiveShadow>
        ...
        <meshStandardMaterial attach="material" color="#F5F2EA" />
      </mesh>
      ...
      <group position={[0, 0.5, -2.5]}>
        <mesh castShadow>
          ...
          <meshStandardMaterial attach="material" color="#2A2D45" />
        </mesh>
      ...
      <mesh position={[0, 0.3, -0.5]} castShadow>
        ...
        <meshStandardMaterial attach="material" color="#B8C4BB" />
      </mesh>
      <mesh position={[0, 0.15, -0.5]} castShadow>
        <boxGeometry args={[0.1, 0.3, 0.1]} />
        <meshStandardMaterial attach="material" color="#4A0404" />
      </mesh>
      ...
      <group position={[2, 0.5, -1.5]} rotation={[0, -Math.PI / 4, 0]}>
        <mesh castShadow>
          ...
          <meshStandardMaterial attach="material" color="#D4AF37" />
        </mesh>
        <mesh position={[0, 0.5, -0.4]} castShadow>
