...
const galleryItems = [
  ...
  {
    id: "gallery_5",
    image: "https://images.unsplash.com/photo-1616137422495-1e9e46e2aa77?auto=format&fit=crop&w=800&q=80",
    customer: "Michelle T.",
    roomType: "Kitchen",
    items: 8,
    likes: 152,
  ...
  {
    id: "gallery_6",
    image: "https://images.unsplash.com/photo-1599327286062-40b0a7f2b305?auto=format&fit=crop&w=800&q=80",
    customer: "Robert H.",
    roomType: "Bathroom",
    items: 4,
    likes: 74,
...
const CustomerGallery = () => {
  return (
    <div className="py-20 bg-deep-indigo/5">
      <div className="container mx-auto">
        <div className="text-center mb-16 px-4">
          <h2 className="text-3xl md:text-4xl font-playfair font-semibold mb-4">
            Spaces Designed by Our Customers
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-4">
          {galleryItems.map((item) => (
            <div 
              key={item.id}
              className="rounded-lg overflow-hidden perspective-card group"
            >
              ...
              <div className="p-4 bg-white">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <div className="flex items-center space-x-1 text-deep-indigo/70">
