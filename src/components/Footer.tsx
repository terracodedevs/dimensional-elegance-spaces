import { Instagram, Facebook, Linkedin, Mail, Package } from "lucide-react";
import { Input } from "@/components/ui/input";
import { Button } from "@/components/ui/button";

const Footer = () => {
  return (
    <footer className="bg-deep-indigo text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <div className="flex items-center mb-4">
              <Package className="h-6 w-6 text-accent-gold mr-2" />
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Collections", "3D Visualizer", "Custom Design", "Inspiration", "About Us"].map((item, index) => (
                <li key={index}>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["FAQ", "Shipping & Returns", "Contact Us", "Privacy Policy", "Terms & Conditions"].map((item, index) => (
                <li key={index}>
                  <a href="#" className="text-white/70 hover:text-white transition-colors">
                    {item}
                  </a>
          ...
          <div>
            <h3 className="font-playfair text-lg font-semibold mb-4">Design Inspiration Delivered</h3>
            ...
            <div className="flex">
              ...
              />
              <Button variant="default" className="bg-accent-gold hover:bg-accent-gold/90 rounded-l-none">
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-white/70 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} Luxe Spaces. All rights reserved.
          </p>
