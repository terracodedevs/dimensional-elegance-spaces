        ...
        <div className="flex justify-between items-end mb-10 px-4">
          <div>
            ...
            <p className="text-deep-indigo/80">
              Curated selection of our finest furniture
            </p>
          </div>
            ...
            >
              <div className="bg-white rounded-lg overflow-hidden shadow-md h-full">
                ...
                <div className="p-5">
                  ...
                  <p className="text-deep-indigo/70 text-sm mb-3">{item.description}</p>
                  <div className="flex justify-between items-center">
                    <span className="text-deep-indigo font-medium">${item.price.toFixed(2)}</span>
                    <Button 
                      onClick={() => handleAddToCart(item)} 
                      className="text-deep-indigo border-deep-indigo/20 hover:bg-deep-indigo hover:text-white"
                      size="sm"
                    >
